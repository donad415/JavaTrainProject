    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Добавление станции</h5>
            ...
            <div class="modal-body">
                <div class="container">
                    ...
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="..." aria-label="Имя"
                               aria-describedby="name-addon"
                               id="departure" name="name" required>
                        <span class="input-group-text" id="departure-addon">Время отбытия</span>
                    </div>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="..." aria-label="Имя"
                               aria-describedby="name-addon"
                               id="coming" name="name" required>
                        <span class="input-group-text" id="coming-addon">Время прибытия</span>
                    </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" value="POST" onclick="sendStation(this.value)" class="btn btn-primary">Сохранить
                </button>
            </div>
        </div>
    </div>
